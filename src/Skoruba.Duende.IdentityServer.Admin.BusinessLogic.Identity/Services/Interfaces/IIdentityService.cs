...
namespace Skoruba.Duende.IdentityServer.Admin.BusinessLogic.Identity.Services.Interfaces
{
        ...
        where TRoleClaimDto : RoleClaimDto<TKey>
    {
        ...
        Task<TUsersDto> GetUsersAsync(string search, int page = 1, int pageSize = 10, string tenantKey = null);
        ...
        Task<IdentityResult> CreateUserRoleAsync(TUserRolesDto role, string tenantKey = null);
        ...
        Task<IdentityResult> DeleteUserRoleAsync(TUserRolesDto role, string tenantKey = null);
