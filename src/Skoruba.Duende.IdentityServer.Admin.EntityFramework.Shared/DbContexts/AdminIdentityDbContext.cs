...
namespace Skoruba.Duende.IdentityServer.Admin.EntityFramework.Shared.DbContexts
{
    public class AdminIdentityDbContext : IdentityDbContext<UserIdentity, UserIdentityRole, string, UserIdentityUserClaim, UserIdentityUserRole, UserIdentityUserLogin, UserIdentityRoleClaim, UserIdentityUserToken>
    {
        ...
        public string SchemaCacheKey =>
            string.Join(
                "|",
                _schemaConfiguration.IdentityRoles ?? string.Empty,
                _schemaConfiguration.IdentityRoleClaims ?? string.Empty,
                _schemaConfiguration.IdentityUserRoles ?? string.Empty,
                _schemaConfiguration.IdentityUsers ?? string.Empty,
                _schemaConfiguration.IdentityUserLogins ?? string.Empty,
                _schemaConfiguration.IdentityUserClaims ?? string.Empty,
                _schemaConfiguration.IdentityUserTokens ?? string.Empty);
