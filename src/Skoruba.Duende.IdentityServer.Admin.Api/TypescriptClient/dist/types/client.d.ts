...
export interface IDebugClaimsClient {
    getCurrent(): Promise<CurrentUserClaimsDebugDto>;
}
export declare class DebugClaimsClient extends WebApiClientBase implements IDebugClaimsClient {
    private http;
    private baseUrl;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined;
    constructor(baseUrl?: string, http?: {
    ...
    getCurrent(): Promise<CurrentUserClaimsDebugDto>;
    protected processGetCurrent(response: Response): Promise<CurrentUserClaimsDebugDto>;
}
...
export interface ITenantsClient {
    getPublicTenants(): Promise<PublicTenantApiDto[]>;
    getTenants(search: string | null | undefined): Promise<TenantApiDto[]>;
    createTenant(model: TenantCreateApiDto): Promise<TenantApiDto>;
    getTenant(id: number): Promise<TenantApiDto>;
    updateTenant(id: number, model: TenantUpdateApiDto): Promise<TenantApiDto>;
    cloneTenant(model: TenantCloneApiDto): Promise<TenantApiDto>;
    getTenantAdmins(id: number): Promise<TenantAdminApiDto[]>;
    assignTenantAdmin(id: number, model: TenantAdminAssignApiDto): Promise<FileResponse>;
    unassignTenantAdmin(id: number, userId: string): Promise<FileResponse>;
}
export declare class TenantsClient extends WebApiClientBase implements ITenantsClient {
    private http;
    private baseUrl;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined;
    constructor(baseUrl?: string, http?: {
    ...
    getPublicTenants(): Promise<PublicTenantApiDto[]>;
    protected processGetPublicTenants(response: Response): Promise<PublicTenantApiDto[]>;
    getTenants(search: string | null | undefined): Promise<TenantApiDto[]>;
    protected processGetTenants(response: Response): Promise<TenantApiDto[]>;
    createTenant(model: TenantCreateApiDto): Promise<TenantApiDto>;
    protected processCreateTenant(response: Response): Promise<TenantApiDto>;
    getTenant(id: number): Promise<TenantApiDto>;
    protected processGetTenant(response: Response): Promise<TenantApiDto>;
    updateTenant(id: number, model: TenantUpdateApiDto): Promise<TenantApiDto>;
    protected processUpdateTenant(response: Response): Promise<TenantApiDto>;
    cloneTenant(model: TenantCloneApiDto): Promise<TenantApiDto>;
    protected processCloneTenant(response: Response): Promise<TenantApiDto>;
    getTenantAdmins(id: number): Promise<TenantAdminApiDto[]>;
    protected processGetTenantAdmins(response: Response): Promise<TenantAdminApiDto[]>;
    assignTenantAdmin(id: number, model: TenantAdminAssignApiDto): Promise<FileResponse>;
    protected processAssignTenantAdmin(response: Response): Promise<FileResponse>;
    unassignTenantAdmin(id: number, userId: string): Promise<FileResponse>;
    protected processUnassignTenantAdmin(response: Response): Promise<FileResponse>;
}
export interface IUserPreferencesClient {
    getPreferences(): Promise<ThemePreferenceApiDto>;
    updatePreferences(request: ThemePreferenceApiDto): Promise<ThemePreferenceApiDto>;
    getThemePreference(): Promise<ThemePreferenceApiDto>;
    updateThemePreference(request: ThemePreferenceApiDto): Promise<ThemePreferenceApiDto>;
}
export declare class UserPreferencesClient extends WebApiClientBase implements IUserPreferencesClient {
    private http;
    private baseUrl;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined;
    constructor(baseUrl?: string, http?: {
    ...
    getPreferences(): Promise<ThemePreferenceApiDto>;
    protected processGetPreferences(response: Response): Promise<ThemePreferenceApiDto>;
    updatePreferences(request: ThemePreferenceApiDto): Promise<ThemePreferenceApiDto>;
    protected processUpdatePreferences(response: Response): Promise<ThemePreferenceApiDto>;
    getThemePreference(): Promise<ThemePreferenceApiDto>;
    protected processGetThemePreference(response: Response): Promise<ThemePreferenceApiDto>;
    updateThemePreference(request: ThemePreferenceApiDto): Promise<ThemePreferenceApiDto>;
    protected processUpdateThemePreference(response: Response): Promise<ThemePreferenceApiDto>;
}
...
export interface IUsersClient {
    ...
    delete(id: string): Promise<void>;
    get2(searchText: string | null | undefined, search: string | null | undefined, page: number | undefined, pageNumber: number | null | undefined, pageSize: number | undefined): Promise<IdentityUsersDto>;
...
export declare class ClientApiDto implements IClientApiDto {
    ...
    useTenantRedirectPairs: boolean;
    tenantRedirectPairs: ClientTenantRedirectPairApiDto[] | undefined;
...
export declare class ClientTenantRedirectPairApiDto implements IClientTenantRedirectPairApiDto {
    tenantKey: string | undefined;
    signInCallbackUrl: string | undefined;
    signOutCallbackUrl: string | undefined;
    corsOrigin: string | undefined;
    constructor(data?: IClientTenantRedirectPairApiDto);
    init(_data?: any): void;
    static fromJS(data: any): ClientTenantRedirectPairApiDto;
    toJSON(data?: any): any;
}
export interface IClientTenantRedirectPairApiDto {
    tenantKey: string | undefined;
    signInCallbackUrl: string | undefined;
    signOutCallbackUrl: string | undefined;
    corsOrigin: string | undefined;
...
export declare class CurrentUserClaimsDebugDto implements ICurrentUserClaimsDebugDto {
    isAuthenticated: boolean;
    authenticationType: string | undefined;
    name: string | undefined;
    roleClaimType: string | undefined;
    hasAdminRole: boolean;
    claims: ClaimDebugItem[] | undefined;
    constructor(data?: ICurrentUserClaimsDebugDto);
    init(_data?: any): void;
    static fromJS(data: any): CurrentUserClaimsDebugDto;
    toJSON(data?: any): any;
}
export interface ICurrentUserClaimsDebugDto {
    isAuthenticated: boolean;
    authenticationType: string | undefined;
    name: string | undefined;
    roleClaimType: string | undefined;
...
export declare class ClaimDebugItem implements IClaimDebugItem {
    type: string | undefined;
    value: string | undefined;
    constructor(data?: IClaimDebugItem);
    init(_data?: any): void;
    static fromJS(data: any): ClaimDebugItem;
    toJSON(data?: any): any;
}
export interface IClaimDebugItem {
    type: string | undefined;
    value: string | undefined;
}
...
export declare class PublicTenantApiDto implements IPublicTenantApiDto {
    displayName: string | undefined;
    constructor(data?: IPublicTenantApiDto);
    init(_data?: any): void;
    static fromJS(data: any): PublicTenantApiDto;
    toJSON(data?: any): any;
}
export interface IPublicTenantApiDto {
    displayName: string | undefined;
}
export declare class TenantApiDto implements ITenantApiDto {
    id: number;
    tenantKey: string | undefined;
    displayName: string | undefined;
    isActive: boolean;
    ...
    createdUtc: Date;
    constructor(data?: ITenantApiDto);
    init(_data?: any): void;
    static fromJS(data: any): TenantApiDto;
    toJSON(data?: any): any;
}
export interface ITenantApiDto {
    id: number;
    tenantKey: string | undefined;
    displayName: string | undefined;
    isActive: boolean;
...
export declare class TenantCreateApiDto implements ITenantCreateApiDto {
    tenantKey: string;
    displayName: string;
    connectionSecrets: {
        [key: string]: string;
    ...
    logoUrl: string | undefined;
    isActive: boolean;
    constructor(data?: ITenantCreateApiDto);
    init(_data?: any): void;
    static fromJS(data: any): TenantCreateApiDto;
    toJSON(data?: any): any;
}
export interface ITenantCreateApiDto {
    tenantKey: string;
    displayName: string;
    connectionSecrets: {
        [key: string]: string;
...
export declare class TenantCloneApiDto implements ITenantCloneApiDto {
    ...
    constructor(data?: ITenantCloneApiDto);
    init(_data?: any): void;
    static fromJS(data: any): TenantCloneApiDto;
    toJSON(data?: any): any;
}
export interface ITenantCloneApiDto {
    sourceTenantId: number;
    tenantKey: string;
    displayName: string;
    connectionSecrets: {
...
export declare class TenantUpdateApiDto implements ITenantUpdateApiDto {
    displayName: string;
    connectionSecrets: {
        [key: string]: string;
    } | undefined;
    ...
    logoUrl: string | undefined;
    isActive: boolean;
    constructor(data?: ITenantUpdateApiDto);
    init(_data?: any): void;
    static fromJS(data: any): TenantUpdateApiDto;
    toJSON(data?: any): any;
}
export interface ITenantUpdateApiDto {
    displayName: string;
    connectionSecrets: {
        [key: string]: string;
    } | undefined;
...
export declare class TenantAdminApiDto implements ITenantAdminApiDto {
    userId: string | undefined;
    userName: string | undefined;
    email: string | undefined;
    constructor(data?: ITenantAdminApiDto);
    init(_data?: any): void;
    static fromJS(data: any): TenantAdminApiDto;
    toJSON(data?: any): any;
}
export interface ITenantAdminApiDto {
    userId: string | undefined;
    userName: string | undefined;
    email: string | undefined;
}
export declare class TenantAdminAssignApiDto implements ITenantAdminAssignApiDto {
    userId: string | undefined;
    constructor(data?: ITenantAdminAssignApiDto);
    init(_data?: any): void;
    static fromJS(data: any): TenantAdminAssignApiDto;
    toJSON(data?: any): any;
}
export interface ITenantAdminAssignApiDto {
    userId: string | undefined;
}
export declare class ThemePreferenceApiDto implements IThemePreferenceApiDto {
    theme: string | undefined;
    isDarkMode: boolean;
    lastPageVisit: string | undefined;
    constructor(data?: IThemePreferenceApiDto);
    init(_data?: any): void;
    static fromJS(data: any): ThemePreferenceApiDto;
    toJSON(data?: any): any;
}
export interface IThemePreferenceApiDto {
    theme: string | undefined;
    isDarkMode: boolean;
    lastPageVisit: string | undefined;
}
