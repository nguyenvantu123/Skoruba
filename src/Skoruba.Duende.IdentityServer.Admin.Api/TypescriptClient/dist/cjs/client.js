...
class WebApiClientBase {
    transformOptions(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign(Object.assign({}, options), { credentials: (_a = options.credentials) !== null && _a !== void 0 ? _a : "include", headers });
        });
    }
}
...
class DebugClaimsClient extends WebApiClientBase {
    constructor(baseUrl, http) {
        super();
        this.jsonParseReviver = undefined;
        this.http = http ? http : window;
...
exports.DebugClaimsClient = DebugClaimsClient;
...
class TenantsClient extends WebApiClientBase {
    constructor(baseUrl, http) {
        super();
        this.jsonParseReviver = undefined;
        this.http = http ? http : window;
    ...
    processGetPublicTenants(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
    ...
    processGetTenantAdmins(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
    ...
    processAssignTenantAdmin(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
    ...
    processUnassignTenantAdmin(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
...
class UserPreferencesClient extends WebApiClientBase {
    constructor(baseUrl, http) {
        super();
        this.jsonParseReviver = undefined;
        this.http = http ? http : window;
    ...
    processUpdatePreferences(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
    ...
    processGetThemePreference(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
    ...
    processUpdateThemePreference(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
...
exports.UserPreferencesClient = UserPreferencesClient;
...
class UsersClient extends WebApiClientBase {
    ...
    get2(searchText, search, page, pageNumber, pageSize) {
    ...
    toJSON(data) {
        ...
        if (Array.isArray(this.tenantRedirectPairs)) {
            ...
            for (let item of this.tenantRedirectPairs)
                data["tenantRedirectPairs"].push(item ? item.toJSON() : undefined);
        }
...
class ClientTenantRedirectPairApiDto {
    constructor(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
...
exports.ClientTenantRedirectPairApiDto = ClientTenantRedirectPairApiDto;
class SelectItemDto {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
class CurrentUserClaimsDebugDto {
    constructor(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
...
exports.CurrentUserClaimsDebugDto = CurrentUserClaimsDebugDto;
class ClaimDebugItem {
    constructor(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
...
exports.ClaimDebugItem = ClaimDebugItem;
...
exports.PublicTenantApiDto = PublicTenantApiDto;
class TenantApiDto {
    constructor(data) {
        if (data) {
            for (var property in data) {
            ...
            if (_data["connectionSecrets"]) {
                ...
                for (let key in _data["connectionSecrets"]) {
                    if (_data["connectionSecrets"].hasOwnProperty(key))
                        this.connectionSecrets[key] = _data["connectionSecrets"][key];
                }
            }
        ...
        if (this.connectionSecrets) {
            ...
            for (let key in this.connectionSecrets) {
                if (this.connectionSecrets.hasOwnProperty(key))
                    data["connectionSecrets"][key] = this.connectionSecrets[key];
            }
        }
...
exports.TenantApiDto = TenantApiDto;
class TenantCreateApiDto {
    constructor(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
...
exports.TenantCreateApiDto = TenantCreateApiDto;
class TenantCloneApiDto {
    constructor(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
...
exports.TenantCloneApiDto = TenantCloneApiDto;
class TenantUpdateApiDto {
    constructor(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
...
exports.TenantUpdateApiDto = TenantUpdateApiDto;
class TenantAdminApiDto {
    constructor(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
...
exports.TenantAdminApiDto = TenantAdminApiDto;
class TenantAdminAssignApiDto {
    constructor(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
...
exports.TenantAdminAssignApiDto = TenantAdminAssignApiDto;
class ThemePreferenceApiDto {
    constructor(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
...
exports.ThemePreferenceApiDto = ThemePreferenceApiDto;
