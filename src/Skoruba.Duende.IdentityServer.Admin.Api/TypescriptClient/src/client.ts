...
export class DebugClaimsClient extends WebApiClientBase implements IDebugClaimsClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getCurrent(): Promise<CurrentUserClaimsDebugDto> {
        let url_ = this.baseUrl + "/api/DebugClaims/GetCurrent";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetCurrent(response: Response): Promise<CurrentUserClaimsDebugDto> {
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = CurrentUserClaimsDebugDto.fromJS(resultData200);
                return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<CurrentUserClaimsDebugDto>(null as any);
    }
}
...
export class TenantsClient extends WebApiClientBase implements ITenantsClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getPublicTenants(): Promise<PublicTenantApiDto[]> {
        let url_ = this.baseUrl + "/api/tenants/public";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetPublicTenants(_response);
        });
    }
    ...
    protected processGetPublicTenants(response: Response): Promise<PublicTenantApiDto[]> {
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
                ...
                if (Array.isArray(resultData200)) {
                    result200 = [] as any;
                    for (let item of resultData200)
                        result200!.push(PublicTenantApiDto.fromJS(item));
                }
                else {
                    result200 = null as any;
                }
        ...
        return Promise.resolve<PublicTenantApiDto[]>(null as any);
    }
    ...
    protected processGetTenants(response: Response): Promise<TenantApiDto[]> {
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
                ...
                if (Array.isArray(resultData200)) {
                    result200 = [] as any;
                    for (let item of resultData200)
                        result200!.push(TenantApiDto.fromJS(item));
                }
                else {
                    result200 = null as any;
                }
        ...
        return Promise.resolve<TenantApiDto[]>(null as any);
    }
    ...
    protected processCreateTenant(response: Response): Promise<TenantApiDto> {
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = TenantApiDto.fromJS(resultData200);
                return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
    ...
    cloneTenant(model: TenantCloneApiDto): Promise<TenantApiDto> {
        let url_ = this.baseUrl + "/api/tenants/clone";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processCloneTenant(_response);
        });
    }
    ...
    getTenantAdmins(id: number): Promise<TenantAdminApiDto[]> {
        let url_ = this.baseUrl + "/api/tenants/{id}/admins";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetTenantAdmins(_response);
        });
    }
    ...
    protected processGetTenantAdmins(response: Response): Promise<TenantAdminApiDto[]> {
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
                ...
                if (Array.isArray(resultData200)) {
                    result200 = [] as any;
                    for (let item of resultData200)
                        result200!.push(TenantAdminApiDto.fromJS(item));
                }
                else {
                    result200 = null as any;
                }
        ...
        return Promise.resolve<TenantAdminApiDto[]>(null as any);
    }
    ...
    assignTenantAdmin(id: number, model: TenantAdminAssignApiDto): Promise<FileResponse> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processAssignTenantAdmin(_response);
        });
    }
    ...
    unassignTenantAdmin(id: number, userId: string): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/tenants/{id}/admins/{userId}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processUnassignTenantAdmin(_response);
        });
    }
...
export class UserPreferencesClient extends WebApiClientBase implements IUserPreferencesClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getPreferences(): Promise<ThemePreferenceApiDto> {
        let url_ = this.baseUrl + "/api/users/preferences";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetPreferences(response: Response): Promise<ThemePreferenceApiDto> {
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = ThemePreferenceApiDto.fromJS(resultData200);
                return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ThemePreferenceApiDto>(null as any);
    }
    ...
    getThemePreference(): Promise<ThemePreferenceApiDto> {
        let url_ = this.baseUrl + "/api/users/preferences/theme";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetThemePreference(_response);
        });
    }
    ...
    updateThemePreference(request: ThemePreferenceApiDto): Promise<ThemePreferenceApiDto> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processUpdateThemePreference(_response);
        });
    }
...
export class ClientApiDto implements IClientApiDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.useTenantRedirectPairs = _data["useTenantRedirectPairs"];
            if (Array.isArray(_data["tenantRedirectPairs"])) {
                this.tenantRedirectPairs = [] as any;
                for (let item of _data["tenantRedirectPairs"])
                    this.tenantRedirectPairs!.push(ClientTenantRedirectPairApiDto.fromJS(item));
            }
    ...
    toJSON(data?: any) {
        ...
        data["useTenantRedirectPairs"] = this.useTenantRedirectPairs;
        if (Array.isArray(this.tenantRedirectPairs)) {
            data["tenantRedirectPairs"] = [];
            for (let item of this.tenantRedirectPairs)
                data["tenantRedirectPairs"].push(item ? item.toJSON() : undefined as any);
        }
...
export class ClientTenantRedirectPairApiDto implements IClientTenantRedirectPairApiDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.tenantKey = _data["tenantKey"];
            this.signInCallbackUrl = _data["signInCallbackUrl"];
            this.signOutCallbackUrl = _data["signOutCallbackUrl"];
            this.corsOrigin = _data["corsOrigin"];
        }
    }

    static fromJS(data: any): ClientTenantRedirectPairApiDto {
        data = typeof data === 'object' ? data : {};
        let result = new ClientTenantRedirectPairApiDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["tenantKey"] = this.tenantKey;
        data["signInCallbackUrl"] = this.signInCallbackUrl;
        data["signOutCallbackUrl"] = this.signOutCallbackUrl;
        data["corsOrigin"] = this.corsOrigin;
        return data;
    }
}
...
export class CurrentUserClaimsDebugDto implements ICurrentUserClaimsDebugDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasAdminRole = _data["hasAdminRole"];
            if (Array.isArray(_data["claims"])) {
                this.claims = [] as any;
                for (let item of _data["claims"])
                    this.claims!.push(ClaimDebugItem.fromJS(item));
            }
        }
    }
    ...
    static fromJS(data: any): CurrentUserClaimsDebugDto {
        data = typeof data === 'object' ? data : {};
        let result = new CurrentUserClaimsDebugDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["hasAdminRole"] = this.hasAdminRole;
        if (Array.isArray(this.claims)) {
            data["claims"] = [];
            for (let item of this.claims)
                data["claims"].push(item ? item.toJSON() : undefined as any);
...
export class ClaimDebugItem implements IClaimDebugItem {
    type!: string | undefined;
    value!: string | undefined;
...
export class PublicTenantApiDto implements IPublicTenantApiDto {
    displayName!: string | undefined;
    ...
    static fromJS(data: any): PublicTenantApiDto {
        data = typeof data === 'object' ? data : {};
        let result = new PublicTenantApiDto();
        result.init(data);
        return result;
    }
...
export class TenantApiDto implements ITenantApiDto {
    id!: number;
    tenantKey!: string | undefined;
    displayName!: string | undefined;
    isActive!: boolean;
    connectionSecrets!: { [key: string]: string; } | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (_data["connectionSecrets"]) {
                this.connectionSecrets = {} as any;
                for (let key in _data["connectionSecrets"]) {
                    if (_data["connectionSecrets"].hasOwnProperty(key))
                        (this.connectionSecrets as any)![key] = _data["connectionSecrets"][key];
                }
            }
    ...
    toJSON(data?: any) {
        ...
        if (this.connectionSecrets) {
            data["connectionSecrets"] = {};
            for (let key in this.connectionSecrets) {
                if (this.connectionSecrets.hasOwnProperty(key))
                    (data["connectionSecrets"] as any)[key] = (this.connectionSecrets as any)[key];
            }
        }
...
export class TenantCreateApiDto implements ITenantCreateApiDto {
    tenantKey!: string;
    displayName!: string;
    connectionSecrets!: { [key: string]: string; } | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.connectionStringSecretName = _data["connectionStringSecretName"];
            this.redirectUrl = _data["redirectUrl"];
            this.logoUrl = _data["logoUrl"];
            this.isActive = _data["isActive"];
        }
    ...
    static fromJS(data: any): TenantCreateApiDto {
        data = typeof data === 'object' ? data : {};
        let result = new TenantCreateApiDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["connectionStringSecretName"] = this.connectionStringSecretName;
        data["redirectUrl"] = this.redirectUrl;
        data["logoUrl"] = this.logoUrl;
        data["isActive"] = this.isActive;
        return data;
...
export class TenantCloneApiDto implements ITenantCloneApiDto {
    ...
    static fromJS(data: any): TenantCloneApiDto {
        data = typeof data === 'object' ? data : {};
        let result = new TenantCloneApiDto();
        result.init(data);
        return result;
    }
...
export class TenantUpdateApiDto implements ITenantUpdateApiDto {
    displayName!: string;
    connectionSecrets!: { [key: string]: string; } | undefined;
    connectionStringSecretName!: string | undefined;
    redirectUrl!: string | undefined;
    ...
    static fromJS(data: any): TenantUpdateApiDto {
        data = typeof data === 'object' ? data : {};
        let result = new TenantUpdateApiDto();
        result.init(data);
        return result;
    }
...
export class TenantAdminApiDto implements ITenantAdminApiDto {
    ...
    static fromJS(data: any): TenantAdminApiDto {
        data = typeof data === 'object' ? data : {};
        let result = new TenantAdminApiDto();
        result.init(data);
        return result;
    }
...
export class TenantAdminAssignApiDto implements ITenantAdminAssignApiDto {
    userId!: string | undefined;
    ...
    static fromJS(data: any): TenantAdminAssignApiDto {
        data = typeof data === 'object' ? data : {};
        let result = new TenantAdminAssignApiDto();
        result.init(data);
        return result;
    }
...
export class ThemePreferenceApiDto implements IThemePreferenceApiDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.lastPageVisit = _data["lastPageVisit"];
        }
    }

    static fromJS(data: any): ThemePreferenceApiDto {
        data = typeof data === 'object' ? data : {};
        let result = new ThemePreferenceApiDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["lastPageVisit"] = this.lastPageVisit;
        return data;
    }
}
