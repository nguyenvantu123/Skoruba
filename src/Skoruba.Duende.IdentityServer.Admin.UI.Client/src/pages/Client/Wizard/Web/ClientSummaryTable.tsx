      ...
      <section>
        ...
        <Table>
          ...
          <TableBody>
            ...
            <TableRow className="flex flex-row">
              <TableCell className="flex-1 p-2">
                {t("Client.Label.UseTenantRedirectPairs_Label")}
              </TableCell>
              <TableCell className="flex-1 p-2">
            ...
            <TableBody>
              {formData.useTenantRedirectPairs ? (
                (formData.tenantRedirectPairs ?? [])
                  ...
                  .map((pair) => (
                    <TableRow className="flex flex-row" key={pair.tenantKey}>
                      <TableCell className="flex-1 p-2">
                        {pair.tenantKey}
                      </TableCell>
                      <TableCell className="flex-1 p-2">
