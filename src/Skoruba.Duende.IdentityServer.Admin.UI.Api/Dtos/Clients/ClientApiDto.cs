...
namespace Skoruba.Duende.IdentityServer.Admin.UI.Api.Dtos.Clients
{
    public class ClientApiDto
    {
        public ClientApiDto()
        {
            ...
            TenantRedirectPairs = new List<ClientTenantRedirectPairApiDto>();
        }
        ...
        public bool UseTenantRedirectPairs { get; set; }
        public List<ClientTenantRedirectPairApiDto> TenantRedirectPairs { get; set; }
