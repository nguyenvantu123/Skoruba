...
namespace Skoruba.Duende.IdentityServer.Admin.EntityFramework.MySql.Migrations.IdentityServerConfiguration
{
    ...
    [Migration("20260401062321_AddClientUseTenantRedirectPairsMode")]
    partial class AddClientUseTenantRedirectPairsMode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.Client", b =>
                {
                    ...
                    b.Property<bool>("UseTenantRedirectPairs")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
            ...
            modelBuilder.Entity("Skoruba.Duende.IdentityServer.Admin.EntityFramework.Admin.Storage.Entities.Configuration.ClientTenantRedirectUri", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SignInCallbackUrl")
                        .HasMaxLength(2000)
                        .HasColumnType("varchar(2000)");

                    b.Property<string>("SignOutCallbackUrl")
                        .HasMaxLength(2000)
                        .HasColumnType("varchar(2000)");
                    ...
                    b.HasIndex("ClientId", "TenantKey")
                        .IsUnique();

                    b.ToTable("ClientTenantRedirectUris", (string)null);
                });
