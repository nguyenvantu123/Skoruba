...
namespace Skoruba.Duende.IdentityServer.Admin.EntityFramework.Repositories.Interfaces
{
    ...
    {
		Task<int> AddClientAsync(Client client, IEnumerable<ClientTenantRedirectUri> tenantRedirectUris = null, bool useTenantRedirectPairs = false);

		Task<int> UpdateClientAsync(Client client, IEnumerable<ClientTenantRedirectUri> tenantRedirectUris = null, bool updateClientClaims = false, bool updateClientProperties = false, bool useTenantRedirectPairs = false);
