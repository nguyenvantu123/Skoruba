...
namespace Skoruba.Duende.IdentityServer.Admin.EntityFramework.Identity.Repositories.Interfaces
{
        ...
        where TUserToken : IdentityUserToken<TKey>
    {
        ...
        Task<PagedList<TUser>> GetUsersAsync(string search, int page = 1, int pageSize = 10, string tenantKey = null);
        ...
        Task<(IdentityResult identityResult, TKey userId)> CreateUserAsync(TUser user, string password = null);
